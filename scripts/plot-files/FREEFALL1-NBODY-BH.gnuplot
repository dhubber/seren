...
set output "FREEFALL1-NBODY-BH.ps"
set size 1.2, 0.6
set origin 0.0,0.0
set pointsize 0.6
unset key
...
'FREEFALL1-NBODY-BH.freefall' every 1 u 1:91 w p lc rgbcolor "black" pt 12,\
'freefall.dat' u ($1):(0.7937005*$2) w l lt 1,\
'FREEFALL1-NBODY-BH.freefall' every 1 u 1:51 w p lc rgbcolor "black" pt 12,\
'freefall.dat' u ($1):(0.4641588*$2) w l lt 1,\
'FREEFALL1-NBODY-BH.freefall' every 1 u 1:11 w p lc rgbcolor "black" pt 12
unset label
...
'FREEFALL1-NBODY-BH.freefall' every 1 u (1 - $1):($91) w p lc rgbcolor "black" pt 12,\
'freefall.dat' u (1 - $1):(0.7937005*$2) w l lt 1,\
'FREEFALL1-NBODY-BH.freefall' every 1 u (1 - $1):($51) w p lc rgbcolor "black" pt 12,\
'freefall.dat' u (1 - $1):(0.4641588*$2) w l lt 1,\
'FREEFALL1-NBODY-BH.freefall' every 1 u (1 - $1):($11) w p lc rgbcolor "black" pt 12
unset label
...
#plot 'freefall.dat' u ($1):(0.965489*$2) w l lt 1,\
#'FREEFALL1-NBODY-BH.freefall' u 1:91 w p lc "black" pt 12,\
#'freefall.dat' u ($1):(0.7937005*$2) w l lt 1,\
#'FREEFALL1-NBODY-BH.freefall' u 1:51 w p lc "black" pt 12,\
#'freefall.dat' u ($1):(0.4641588*$2) w l lt 1,\
#'FREEFALL1-NBODY-BH.freefall' u 1:11 w p lc "black" pt 12
#unset label
